...
export async function POST(req: Request) {
  try {
    ...
    if (!apiKey || apiKey.trim() === "") {
      console.warn("MOONSHOT_API_KEY is not defined. Falling back.");
    ...
    const personality = persona?.personalityDesc || factionDescs[citizen.faction] || "A regular internet citizen posting memes.";
